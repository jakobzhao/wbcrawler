...
@author: Bo Zhao
@e-mail: jakbzhao@gmail.com
@web: http://yenching.org
'''
...
class PyICTCLAS(object):
    def __init__(self, lib_path = './ICTCLAS/libICTCLAS50.so'):
        ...
        self.ictclas_init()
        #return self._ictclas_lib._Z12ICTCLAS_InitPKc(init_dir) 
    ...
    def ictclas_importUserDict(self, filename, code_type):
        ...
        f.close()
        #print user_dict
        return self._ictclas_lib._Z22ICTCLAS_ImportUserDictPKci9eCodeType(c_char_p(user_dict), code_type)
